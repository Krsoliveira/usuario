package com.projetocadastro.usuario.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuario").authenticated() // Requer autenticação para qualquer endpoint que comece com /usuario/
                        .requestMatchers(HttpMethod.DELETE, "/usuario/**").authenticated() // Requer autenticação para qualquer endpoint DELETE que comece com /usuario/
